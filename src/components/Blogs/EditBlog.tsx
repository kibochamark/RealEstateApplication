...
import { updateBlogData } from "@/actions/Blog";
...
export default function EditBlog({ blogs }: { blogs: any }) {
  ...
  return (
    <Card className="w-full border-none shadow-none">
      <CardHeader>
        <CardTitle className="text-2xl sm:text-3xl">Edit Blog</CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={formik.handleSubmit} className="space-y-8 bg-white">
          ...
          <Button type="submit" className="w-full" disabled={isLoading}>
            {isLoading ? <Loader className="animate-spin text-blue-500 w-6 h-6 mr-2" /> : null}
            Update Blog
          </Button>
        </form>
      </CardContent>
