  ...
  return (
    ...
    >
      <div className="relative h-64 group">
        <Image
          src={imageUrl?.length > 0 ? imageUrl : "/9.jpg"}
          alt={name}
      ...
      <div className="py-6">
        <h3 className="text-xl text-secondary500 font-semibold mb-2" 
        dangerouslySetInnerHTML={{ __html: name }}></h3>
        <div
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm text-secondary500">
