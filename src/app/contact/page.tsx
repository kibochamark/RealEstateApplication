...
export default function ContactPage() {
    ...
    return (
        ...
        >
            ...
            <Card className="w-full relative max-w-6xl bg-transparent backdrop-blur-md rounded-none border-none outline-none">
                <CardHeader>
                    <CardTitle className="text-center text-white text-2xl my-4 font-bold">Contact Intime Homes</CardTitle>
                </CardHeader>
                <CardContent className="flex flex-col md:flex-row space-y-6 gap-6">
